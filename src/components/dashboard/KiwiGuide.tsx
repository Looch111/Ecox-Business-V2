        ...
        <CardContent className="space-y-4 pt-6">
          <div className="prose dark:prose-invert max-w-none text-sm text-muted-foreground space-y-4">
            <p>
              ...
              on an Android device. This browser allows you to use desktop
              developer tools.
            </p>
            <h3 className="text-foreground font-semibold">Critical Reminder</h3>
            <ul className="list-disc list-outside space-y-2 pl-4">
              <li>Log into your Ecox account within the Kiwi Browser.</li>
              <li>
                <span className="font-bold text-destructive">
                  Do not log out
                </span>{" "}
                of your Ecox account from the Kiwi browser at any point during
                this process.
              </li>
              <li>
                You must complete all steps, from getting the token to
                submitting the form, in the same session.
              </li>
            </ul>
          </div>
        </CardContent>
        <CardFooter>
          <Button onClick={onNext}>I Understand, Close</Button>
        </CardFooter>
      </Card>
    </div>
  );
